...
export const theme = {
  ...
  // Typography
  fontFamily: {
    // Outfit font family with all weights
    thin: "Outfit_100Thin",
  ...
  // Gradient presets
  gradients: {
    background: ["#08171c", "#1e313b"] as [string, string], 
    backgroundAnimated: ["#08171c", "#1B263B", "#1e313b"] as [
      string,
      string,
      string
    ],
    glass: ["rgba(30, 49, 59, 0.4)", "rgba(30, 49, 59, 0.2)"] as [
      string,
      string
    ],
    primary: ["#38BDF8", "#67E8F9"] as [string, string], 
    success: ["#34D399", "#67E8F9"] as [string, string],
    reflection: ["rgba(255, 255, 255, 0.15)", "rgba(255, 255, 255, 0)"] as [
      string,
      string
    ],
    energyRing: ["rgba(103, 232, 249, 0.1)", "rgba(103, 232, 249, 0)"] as [
      string,
      string
    ],
  },
